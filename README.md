About probableparsing-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/probableparsing-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5158&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/probableparsing-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `probableparsing` can be installed with `conda`:
...
```
mamba install probableparsing
```

It is possible to list all of the versions of `probableparsing` available on your platform with `conda`:
...
```
mamba search probableparsing --channel conda-forge
```
...
mamba repoquery search probableparsing --channel conda-forge

# List packages depending on `probableparsing`:
mamba repoquery whoneeds probableparsing --channel conda-forge

# List dependencies of `probableparsing`:
mamba repoquery depends probableparsing --channel conda-forge
```
